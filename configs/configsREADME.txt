...
studentNames.txt - This file should contain the names of your students.
  This file should not change project to project.
  in this format:   
    First Last,GhUsername
    John Doe,Jdoe123
    etc.
    etc.

constants.txt - This file containts constants which are changed every
  time that the project number is changed, or year changes. They are used
  to create the .git links.
  
  They should be formatted as so:
    year=21f
    project=PA 02

Do not edit any of the files in the directory dontTouchMe/. They are used by the program for
intra-language data transfer and such.
